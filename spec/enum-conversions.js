...
describe('bacnet enum conversions', () => {
  describe('objectTypeToString', () => {
    ...
    it('errors on "foo"', () => {
      ...
      }, Error, 'no error was thrown for invalid object type "foo"')
    })
    it('errors on -1', () => {
      should.throws(() => {
  ...
  describe('propertyKeyToString', () => {
    ...
    it('errors on "foo"', () => {
      ...
      }, Error, 'no error was thrown for invalid property key "foo"')
    })
    it('errors on -1', () => {
      should.throws(() => {
        bacnet.propertyKeyToString(-1)
      }, Error, 'no error was thrown for invalid property key -1')
    })
    it('errors on 4194304', () => {
      should.throws(() => {
        bacnet.propertyKeyToString(4194304)
      }, RangeError, 'no error was thrown for invalid property key 4194304')
    })
  })
